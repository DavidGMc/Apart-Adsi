...
public class ActivityLogin extends AppCompatActivity implements FrgLogin.IFrgLogin, FrgRegister.IFrgRegister {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityLoginToolbar.setTitle("Login");  //titulo de la pantalla
    ...
    @Override  // cuadro de dialogo inferior , si la autenticacion falla
    public void logFail() {
    ...
    @Override  //verificar si el usuario ha sido creado.
   ...
   //metodo para ir a actividad principal
    private void showHome() {
        Intent intent = new Intent(this, ActivityHome.class);
        startActivity(intent);
        finish();
    }
    // metodo para abrir el fragment de iniciar sesion
