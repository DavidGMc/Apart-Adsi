...
public class ActivityHome extends AppCompatActivity implements FrgHome.HomeInterface, FrgUser.ListUser, FrgBack, FrgLists,
    ...
    public static final int FRAGMENT_HOME = 100;  //variable estatica de la clase para inicio
    public static final int FRAGMENT_INFORMATION = 101; //variable estatica de la clase para informacion
    public static final int FRAGMENT_PROFILE = 102;    //variable estatica de la clase para comunidad
    public static final int FRAGMENT_LIST_COMMUNITY = 110; //variable estatica  para listar la comunidad
    public static final int FRAGMENT_LIST_DOCUMENT = 111;  //variable estatica  para listar documentos
    public static final int FRAGMENT_LIST_ENTRYF = 112;  //etc
    ...
    @BindView(R.id.activity_main_drawer)//menu lateral
    ...
    @OnClick(R.id.activity_main_action)//metodomenu para elegir opcion deseada
    ...
    @Override
    public void changeCode(String code) { //cambio en ele codigo
        actual_code = code;
    ...
    @Override    //metodos para eliminar comunidad, documentos , incidencias etc;
    ...
    @Override
    public void newImage(String photo) {// cambio en la imagen
        actual_photo = photo;
        if (!"".equals(actual_photo)) {
            Glide.with(ActivityHome.this).load(actual_photo).centerCrop().into(profile_image);
        }
    ...
    @Override
    public void newName(String name) {// cambio en el nombre
        actual_name = name;
