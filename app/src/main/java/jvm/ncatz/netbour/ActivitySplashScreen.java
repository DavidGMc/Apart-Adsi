...
public class ActivitySplashScreen extends AppCompatActivity {
    ...
    private void checkUser() {
     ...
     //si el usuario ya ha sido registrado y verificado , se inicirara la actividad de inicio
    private void showHome() {
        Intent intent = new Intent(this, ActivityHome.class);
        startActivity(intent);
        finish();
    }
    // si el usuario entra por primera vez o no ha sido loqueado , iniciara la actividad de login.
